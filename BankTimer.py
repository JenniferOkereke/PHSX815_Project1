...
if likelihood_more_tuesday > likelihood_less_tuesday:
    ...
    #Plot histogram for scenario 1
plt.hist(results_1.flatten(), bins=np.arange(0, 20), alpha=0.5, label='Scenario 1', density=True)
plt.xlabel("Waiting Time")
plt.ylabel("Probability Density")
plt.title("Scenario 1")
plt.show()

# Plot histogram for scenario 2
plt.hist(results_2.flatten(), bins=np.arange(0, 20), alpha=0.5, label='Scenario 2', density=True)
plt.xlabel("Waiting Time")
plt.ylabel("Probability Density")
